...
After completing the full pipeline, your monorepo will contain:
...
│   ├── mood-images/                  # Your 12 reference photographs
│   │   └── *.jpg
...
Processes all images in design-system/mood-images/ and produces:
...
1. Scan `design-system/mood-images/` for all `.jpg`, `.jpeg`, `.png` files
...
```json
{
  ...
  "colors": {
    "text": {"hex": "#1a1a2e", "role": "Primary text color"},
    "background": {"hex": "#f5f5f0", "role": "Page background"},
    "primary": {"hex": "#2D6A4F", "role": "Swiss green — buttons, links, primary actions"},
    "secondary": {"hex": "#C1121F", "role": "Swiss red — alerts, badges, streaks"},
    "accent": {"hex": "#E9C46A", "role": "Warm accent — highlights, active states"}
  },
  "css_export": "/* paste Realtime Colors CSS export here */",
  "tailwind_export": "/* paste Realtime Colors Tailwind export here */"
}
```
...
Secondary font: [YOUR CHOICE or "none — Overpass only"]
Monospace font: Overpass Mono (for any data/code display)
```
...
- [ ] 12 mood images placed in `design-system/mood-images/`
